/*{
    "DESCRIPTION": "2V-P ISF MULTI PASS GAUSSIAN BLUR",
	...
	"PASSES": [
		{
			"TARGET": "smallA",
			"WIDTH": "floor($WIDTH*min((0.4/($blurAmount/100.0)),1.0))",
			"HEIGHT": "floor($HEIGHT*min((0.4/($blurAmount/100.0)),1.0))"
		},
		{
			"TARGET": "smallB",
			"WIDTH": "floor($WIDTH*min((0.4/($blurAmount/100.0)),1.0))",
		...
		{
			"TARGET": "smallC",
			"WIDTH": "floor($WIDTH*min((0.6/($blurAmount/100.0)),1.0))",
			"HEIGHT": "floor($HEIGHT*min((0.6/($blurAmount/100.0)),1.0))"
		},
		{
			"TARGET": "smallD",
			"WIDTH": "floor($WIDTH*min((0.6/($blurAmount/100.0)),1.0))",
		...
		{
			"TARGET": "smallE",
			"WIDTH": "floor($WIDTH*min((1./($blurAmount/100.0)),1.0))",
			"HEIGHT": "floor($HEIGHT*min((1./($blurAmount/100.0)),1.0))"
		},
		{
			"TARGET": "smallF",
			"WIDTH": "floor($WIDTH*min((1./($blurAmount/100.0)),1.0))",
		...
		{
			"TARGET": "smallG",
			"WIDTH": "floor($WIDTH*min((1.6/($blurAmount/100.0)),1.0))",
			"HEIGHT": "floor($HEIGHT*min((1.6/($blurAmount/100.0)),1.0))"
		},
		{
			"TARGET": "smallH",
			"WIDTH": "floor($WIDTH*min((1.6/($blurAmount/100.0)),1.0))",
